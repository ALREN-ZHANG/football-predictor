...
def train_models():
    ...
    # 使用时序交叉验证（只指定 n_splits，不指定 test_size，以避免参数冲突）
...
tab1, tab2, tab3 = st.tabs(["📈 赔率分析", "📝 录入比赛", "📊 历史记录（只读）"])
